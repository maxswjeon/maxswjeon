...
function App() {
    return (
        <div className="print:w-[21cm] print:h-[29.7cm] print:border-none print:m-0 print:p-0 container mx-auto sm:my-12 p-6 sm:shadow-card rounded-3xl">
            <header className="flex mb-3 py-2">
                ...
                <img
                    className="rounded-full print:w-[3.5cm] print:h-[3.5cm] box-border print:m-[0.5cm] w-[27.5vw] h-[27.5vw] max-w-[125px] max-h-[125px] ml-6"
                    src={Character}
                    alt="Profile Image"
                />
            </header>
